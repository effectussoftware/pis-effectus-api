  ...
  describe 'GET api/v1/admin/communications' do
    context 'with authorization' do
      it 'returns the first 20 communications' do
        ...
        expect(response_body['communications']).to eq(communications[0..19].as_json)
      end
      ...
      it 'returns the second page of communications' do
        ...
        expect(response).to have_http_status 200
        response_body = Oj.load(response.body)
        expect(response_body['communications']).to eq(communications[20..39].as_json)
      end
      ...
      it 'returns the first page with ten communications' do
        ...
        expect(response_body['communications']).to eq(communications_expected.as_json)
      end
      ...
      it 'returns all communications published' do
        ...
        expect(response_body['communications']).to eq(communications_published[0..19].as_json)
      end
      ...
      it 'returns all communications order by created_at' do
        ...
        expect(response_body['communications']).to eq(communications_expected[0..19].as_json)
      end
    end
